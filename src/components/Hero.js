  ...
  return (
    <section id="home" className="relative py-8 md:py-16 overflow-hidden flex flex-col items-center">
      ...
      <div className="w-full max-w-6xl z-10 px-4">
        {/* Available Pill */}
        <div className="inline-flex items-center gap-2 bg-[var(--bg-secondary)] border border-[var(--border-color)] text-[var(--text-secondary)] rounded-full px-4 py-1.5 text-xs font-semibold shadow-sm mb-8 animate-pulse">
