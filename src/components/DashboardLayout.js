...
// Lazy load recruiter dashboard & popup since they are rarely used instantly
...
export default function DashboardLayout({ children }) {
  ...
  // Monitor scroll via IntersectionObserver
  useEffect(() => {
  ...
  return (
    <DashboardContext.Provider value={{ setIsAssistantOpen, setIsRecruiterMode, activeSection, bootDone }}>
      {/* AI Boot Loader */}
      {showBoot && (
        <AIBootLoader
          onComplete={() => {
          ...
          <div className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start relative mt-6 lg:mt-16">
              ...
              <main className="lg:col-span-8 space-y-24 pb-20 lg:pb-0">
                ...
                {/* Server Components are injected here */}
                {children}
              </main>
