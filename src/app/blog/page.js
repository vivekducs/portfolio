      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
          {posts.length === 0 ? (
            ...
            posts.map((post) => (
              <article key={post.slug} className="glass-card rounded-2xl border border-[var(--glass-border)] p-6 md:p-8 hover:border-luxury-purple/40 transition-all">
                <Link href={`/blog/${post.slug}`} className="block h-full w-full group">
                  ...
                  <h2 className="text-xl md:text-2xl font-bold text-[var(--text-primary)] mb-3 group-hover:text-luxury-orange transition-colors">
                    {post.title}
                  </h2>
                  ...
                  <div className="flex items-center justify-between mt-auto">
                    ...
                    <span className="text-xs font-bold text-luxury-orange flex items-center gap-1 group-hover:translate-x-1 transition-transform">
